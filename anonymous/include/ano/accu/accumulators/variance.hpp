...
#include <ano/accu/accumulators/count.hpp>
#include <ano/accu/accumulators/mean.hpp>
#include <ano/accu/accumulators/sum.hpp>
#include <ano/accu/composite_accumulator.hpp>
  ...
  namespace accu
  {
    ...
    namespace accumulators
    {
      ...
      struct variance : accumulator_base<variance<T, SumType, SumSqrType>, T, double, features::variance<>>
      {
        ...
        friend result_type extract(const variance& accu, features::variance<ST1, ST2>)
        {
          if (accu.m_count == 0)
            return 0;
        ...
        friend unsigned extract(const variance& accu, features::count<>) { return accu.m_count; }
