...
namespace ano::archetypes
{
  ...
  {
    template <class I>
    struct AsImage : I, ano::details::Image<AsImage<I>>
    {
      using I::I;
    ...
    struct ConcreteImage
    {
      ...
      using value_type    = pixel_value_t<ano::archetypes::Pixel>;
      using reference     = pixel_reference_t<ano::archetypes::Pixel>;
    ...
    struct OutputImage : Image
    {
      ...
      using reference  = pixel_reference_t<ano::archetypes::OutputPixel>;
    ...
    {
      struct Extension : ::ano::Extension<Extension>
      {
        ...
        bool fit(ano::archetypes::StructuringElement<image_point_t<Image>, ano::archetypes::Pixel> se) const;
        int  extent() const;
      };

      using extension_type = Extension;

      using extension_category = ano::extension::custom_extension_tag;
