...
#include <ano/core/se/view/filter.hpp>
...
namespace ano::extension
{
  ...
  public:
                            ...
                            image_domain_t<::concepts::remove_cvref_t<Ima>>>
    {
      ...
      // static_assert(ano::is_a<SE, ano::StructuringElement>::value);
  ...
  public:
                            ...
                            value_extended_view<::concepts::remove_cvref_t<Ima>>>
    {
      ...
      static_assert(ano::is_a<I, ano::details::Image>::value);
      // static_assert(ano::is_a<S, ano::StructuringElement>::value);
      ...
      ano::trace::warn("[Performance] Either the extension of the image is two small or the underlying extension does "
  ...
  public:
                            ...
                            image_extended_view<::concepts::remove_cvref_t<Ima>>>
    {
      ...
      ano::trace::warn("[Performance] Either the extension of the image is two small or the underlying extension "
  ...
  public:
        ...
        -> image_concrete_t<::concepts::remove_cvref_t<InputImage>>
    {
      ...
      ano::impl::paste_unsafe(ima, input_roi, output);
      return output;
    }
  };
  ...
  public:
                            ...
                            image_domain_t<::concepts::remove_cvref_t<Ima>>>
    {
      using I = ::concepts::remove_cvref_t<Ima>;
      static_assert(ano::is_a<I, ano::details::Image>::value);
      // static_assert(ano::is_a<SE, ano::details::StructuringElement>::value);
