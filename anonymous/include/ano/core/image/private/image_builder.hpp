...
namespace ano
{
  ...
  /// corresponding free functions \ref ano::imconcretize and \ref ano::imchvalue() ).
  ...
  {
    static_assert(ano::is_a<To, ano::details::Image>());
    static_assert(ano::is_a<From, ano::details::Image>());
    return {to, from};
  }
