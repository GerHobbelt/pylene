...
namespace ano::details
{
  ...
  struct ndpix : ano::details::Pixel<ndpix<T, N>>
  {
  ...
  public:
    const ano::details::ndbuffer_image_info_t* m_info;
    T*                                         m_lineptr;
    point_type                                 m_point;
  };
  ...
  template <class T, int N>
  class ndpix_range : public ano::ranges::details::mdview_facade<ndpix_range<T, N>>
  {
  public:
    struct cursor : ano::ranges::details::ndcursor_facade<cursor>
    {
    ...
    struct backward_cursor : ano::ranges::details::ndcursor_facade<backward_cursor>
    {
      static constexpr int rank = N;
    ...
    ndpix_range(const ano::details::ndbuffer_image_info_t* info)
      : m_info{*info}
    {
    }

  private:
    ano::details::ndbuffer_image_info_t m_info;
  };
