...
namespace ano
{
  ...
  namespace detail
  {
    ...
    template <class I>
    struct image_adaptor_base_with_extension<
        I, std::enable_if_t<not std::is_same_v<image_extension_category_t<I>, ano::extension::none_extension_tag>>>
    {
  ...
  public:
    ...
    /// \{
    template <typename dummy = I>
    std::enable_if_t<not std::is_same_v<extension_category, ano::extension::none_extension_tag>,
