...
namespace ano
{
  ...
  class clip_view : public image_adaptor<I>, public ano::details::Image<clip_view<I, D>>
  {
    D m_subdomain;
  ...
  public:
    ...
    static_assert(std::is_convertible_v<ano::ranges::mdrange_value_t<D>, point_type>,
  ...
  public:
    ...
    {
      // ano_precondition(::ranges::includes(m_ima.domain(), m_subdomain)); //FIXME
    }
    ...
    auto values()
    {
      ...
      return ano::ranges::view::transform(m_subdomain, g);
    }
  ...
  namespace view
  {
    ...
    template <class I, class D>
    clip_view<I, D> clip(const ano::details::Image<I>& ima, D domain)
    {
