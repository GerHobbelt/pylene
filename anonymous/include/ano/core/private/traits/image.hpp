...
#include <ano/core/private/categories/image.hpp>
...
namespace ano
{
  ...
  template <class I>
  using image_has_extension = std::is_convertible<image_extension_category_t<I>, ano::extension::custom_extension_tag>;
  ...
  template <class I>
  using image_has_border = std::is_convertible<image_extension_category_t<I>, ano::extension::border_extension_tag>;
