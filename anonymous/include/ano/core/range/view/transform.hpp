...
namespace ano::ranges
{
  namespace details
  {
    ...
    struct transform_mdcursor : mdcursor_facade<transform_mdcursor<Cur, Fun>>
    {
      ...
      {
        return ::ranges::range_access::equal(m_cur, ::ranges::default_sentinel);
      }
    ...
    struct transform2_mdcursor : mdcursor_facade<transform2_mdcursor<Cur1, Cur2, Fun>>
    {
      ...
      bool equal(::ranges::default_sentinel_t) const
      {
        return ::ranges::range_access::equal(m_cur1, ::ranges::default_sentinel);
      }
  ...
  struct transform2_mdview<Rng1, Rng2, Fun> : details::mdview_facade<transform2_mdview<Rng1, Rng2, Fun>>
  {
    ...
    using backward_cursor =
        details::transform2_mdcursor<typename Rng1::backward_cursor, typename Rng2::backward_cursor, Fun>;
    ...
    backward_cursor rbegin_cursor() const { return {{}, m_rng1.rbegin_cursor(), m_rng2.rbegin_cursor(), m_fun}; }
