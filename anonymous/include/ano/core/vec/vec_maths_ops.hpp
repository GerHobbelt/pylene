...
#include <ano/core/vec/private/def_gen_code_macros.hpp>
...
namespace ano
{
  ...
  ANO_VEC_PRIVATE_GEN_UNARY_CODE(sqr);
  ANO_VEC_PRIVATE_GEN_UNARY_CODE(sqrt);
  ANO_VEC_PRIVATE_GEN_UNARY_CODE(abs);
  ANO_VEC_PRIVATE_GEN_UNARY_CODE(cbrt);

  ANO_VEC_PRIVATE_GEN_BINARY_CODE(l0dist, l0norm, x - y);
  ANO_VEC_PRIVATE_GEN_BINARY_CODE(l1dist, l1norm, x - y);
  ANO_VEC_PRIVATE_GEN_BINARY_CODE(l2dist, l2norm, x - y);
  ANO_VEC_PRIVATE_GEN_BINARY_CODE(l2dist_sqr, l2norm_sqr, x - y);
  ANO_VEC_PRIVATE_GEN_BINARY_CODE(linfdist, linfnorm, x - y);
...
#include <ano/core/vec/private/undef_gen_code_macros.hpp>
