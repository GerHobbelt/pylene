...
namespace ano::io::oiio::internal
{
  class openimageio_reader_plugin final : public ano::io::internal::plugin_reader
  {
  public:
  ...
  class openimageio_writer_plugin final : public ano::io::internal::plugin_writer
  {
  public:
