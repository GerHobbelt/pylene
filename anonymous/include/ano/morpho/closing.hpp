...
namespace ano::morpho
{
  ...
  void closing(InputImage&& image, const ano::details::StructuringElement<SE>& se, BorderManager bm, OutputImage&& out);
  ...
  closing(InputImage&& image, const ano::details::StructuringElement<SE>& se, BorderManager bm,
  ...
  closing(InputImage&& image, const ano::details::StructuringElement<SE>& se, OutputImage&& out);
  ...
  void closing(InputImage&& image, const ano::details::StructuringElement<SE>& se, BorderManager bm, OutputImage&& out)
  {
    ano_entering("ano::morpho::closing");
    ...
    auto tmp = ano::morpho::dilation(image, se, bm);
    ano::morpho::erosion(tmp, se, bm, out);
  }
  ...
  {
    ano_entering("ano::morpho::closing");
    auto tmp = ano::morpho::dilation(image, se);
    ano::morpho::erosion(tmp, se, out);
  }
                                                                ...
                                                                const ano::details::StructuringElement<SE>& se)
  {
    ...
    ano::morpho::closing(image, se, out);
    return out;
  }
  ...
  {
    auto out = imconcretize(image).build();
    ano::morpho::closing(image, se, bm, out);
    return out;
  }
