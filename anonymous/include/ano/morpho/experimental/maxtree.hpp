...
#include <ano/morpho/experimental/canvas/depthfirst.hpp>
...
namespace ano::morpho::experimental
{
  ...
  namespace details
  {
    ...
    permute_parent_and_node_map(I&& node_map, int* parent, V* levels, std::size_t n)
    {
      ...
      ano::for_each(node_map, [perm](int& i) { i = perm[i]; });
    }
  } // namespace details
  ...
  maxtree(I input, N nbh)
  {
    ano_entering("ano::morpho::experimental::maxtree");
