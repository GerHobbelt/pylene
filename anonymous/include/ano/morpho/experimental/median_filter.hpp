...
#include <ano/morpho/experimental/rank_filter.hpp>
...
namespace ano::morpho::experimental
{
  ...
  median_filter(InputImage&& image, const ano::StructuringElement<SE>& se, BorderManager bm);

  template <class InputImage, class SE, class BorderManager, class OutputImage>
  void median_filter(InputImage&& image, const ano::StructuringElement<SE>& se, BorderManager bm, OutputImage&& out);
  ...
  template <class InputImage, class SE, class BorderManager, class OutputImage>
  void median_filter(InputImage&& input, const ano::StructuringElement<SE>& se, BorderManager bm, OutputImage&& out)
  {
