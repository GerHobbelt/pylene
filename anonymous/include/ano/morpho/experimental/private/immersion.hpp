...
#include <ano/morpho/experimental/private/immersion.spe.hpp>
...
namespace ano::morpho::experimental::details
{
  ...
  namespace impl
  {
    ...
    {
      ano_entering("ano::morpho::experimental::details::immersion (2d-buffer)") immersion_impl_table_t<T> impl;
    ...
    {
      ano_entering("ano::morpho::experimental::details::immersion (3d-buffer)") immersion_impl_table_t<T> impl;
      immersion_ndimage(f, inf, sup, &impl);
    }
    ...
    {
      ano_entering("ano::morpho::experimental::details::immersion (generic)")
