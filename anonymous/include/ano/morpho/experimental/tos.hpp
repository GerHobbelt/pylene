...
#include <ano/morpho/experimental/maxtree.hpp>
#include <ano/morpho/experimental/private/immersion.hpp>
#include <ano/morpho/experimental/private/propagation.hpp>
...
namespace ano::morpho::experimental
{
  ...
  auto tos(I input, image_point_t<I> pstart, int /* processing_flags */)
  {
    ...
    static_assert(std::is_same_v<Domain, ano::box2d> || std::is_same_v<Domain, ano::box3d>,
    ...
    auto casted         = ano::view::cast<uint16_t>(ord);
