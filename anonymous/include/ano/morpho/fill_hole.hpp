...
namespace ano::morpho
{
  ...
  namespace impl
  {
    ...
    template <typename I, typename N, typename J>
    [[gnu::noinline]] void fill_hole(I&& input, N nbh, J&& out, image_point_t<std::remove_reference_t<I>> pinf)
    {
  ...
  void fill_hole(I input, N nbh, image_point_t<I> marker, J out)
  {
    ...
    static_assert(std::is_convertible<image_value_t<I>, bool>::value,
