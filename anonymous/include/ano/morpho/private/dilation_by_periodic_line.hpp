...
#include <ano/morpho/private/running_max_1d.hpp>
...
namespace ano::morpho::details
{
  ...
  template <class I, class J, class BinaryFunction>
  void dilation_by_periodic_line(I& in, J& out, const ano::se::periodic_line2d& line, BinaryFunction sup,
                                 ano::box2d roi)
  {
    ...
    auto fun = [&, k](ano::point2d origin, ano::point2d dir, std::size_t n) {
      ...
      ano::morpho::details::running_max_1d(p.get() + k, g.get() + k, h.get() + k, (int)n, k, sup);
