...
namespace ano
{
  ...
  {
  public:
    ParallelLocalCanvas2DImpl(ParallelLocalCanvas2DBase* delegate) { m_delegate = delegate->clone(); }

    ParallelLocalCanvas2DImpl(const ParallelLocalCanvas2DImpl& other) { m_delegate = other.m_delegate->clone(); }
  ...
  */
  void ParallelLocalCanvas2DBase::execute_parallel(ano::box2d roi, int tile_width, int tile_height)
  {
  ...
  void ParallelLocalCanvas2DBase::execute_sequential(ano::box2d roi, int tile_width, int tile_height)
  {
  ...
  void ParallelLocalCanvas2DBase::execute(ano::box2d roi, int tile_width, int tile_height, bool parallel)
  {
    if (parallel)
  ...
  void ParallelLocalCanvas2D::ExecuteTile(ano::box2d roi) const
  {
    ano::box2d input_roi = this->ComputeInputRegion(roi);
