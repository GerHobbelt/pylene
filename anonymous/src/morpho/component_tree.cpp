...
namespace ano::morpho
{
  ...
  ano::image2d<double> component_tree<void>::saliency(ano::image2d<int> node_map, ::ranges::span<double> values) const
  {
    ...
    ano_foreach (auto p, node_map.domain())
    {
