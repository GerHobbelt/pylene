#include <ano/morpho/waterfall.hpp>
...
namespace ano::morpho::details
{
  ...
  void mst_waterfall_visitor::on_union(int p, int rp, int q, int rq, ano::dontcare_t)
  {
  ...
  void waterfall_bpt_visitor::on_union(ano::dontcare_t, int rp, ano::dontcare_t, int rq, int w)
  {
