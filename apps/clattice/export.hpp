                                  ...
                                  const std::string& dirname)
{
  ...
  dotsream << "   shape_" << id << "[shape=rectangle,label=\"\","
           << "image=\"" << dirname << "/"
           << "shape_" << id << ".png\", imagescale=true];" << std::endl
           << "  }" << std::endl;
                ...
                const mln::image2d<V>& ima, const std::string& filename, const std::string& dirname)
{
  ...
  file << "digraph G {" << std::endl << "  compound = true;" << std::endl;
