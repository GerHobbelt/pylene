...
struct rng_porder_less
{
  ...
  bool operator()(const Vec& u, const Vec& v) const { return mln::vecprod_isless(u, v); }

  Vec inf(const Vec& u, const Vec& v) const { return mln::inf(u, v, mln::productorder_less<Vec>()); }
};
...
struct rng_porder_greater
{
  ...
  bool operator()(const Vec& u, const Vec& v) const { return mln::vecprod_isgreater(u, v); }

  Vec inf(const Vec& u, const Vec& v) const { return mln::sup(u, v, mln::productorder_less<Vec>()); }
};
...
struct rng_porder_less_equal
{
  ...
  bool operator()(const Vec& u, const Vec& v) const { return mln::vecprod_islessequal(u, v); }
...
struct rng_porder_greater_equal
{
  ...
  bool operator()(const Vec& u, const Vec& v) const { return mln::vecprod_isgreaterequal(u, v); }
...
struct rng_porder_equal_to
{
  ...
  {
    return mln::vecprod_islessequal(rng.lower, v) and mln::vecprod_islessequal(v, rng.upper);
  }

  bool operator()(const Vec& u, const Vec& v) const { return u == v; }

  Vec inf(const Vec& u, const Vec&) const { return u; }
};
...
struct rng_porder_not_equal_to
{
  ...
  bool operator()(const range_t& rng, const Vec& v) const
  {
    return mln::vecprod_isless(v, rng.lower) or mln::vecprod_isgreater(v, rng.upper);
  }
