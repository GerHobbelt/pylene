...
namespace mln
{
  ...
  morpho::component_tree<unsigned, image2d<unsigned>>
      compute_ctos(const image2d<V>& input, image2d<uint16>* depth = nullptr, e_ctos_attribute attribute = CTOS_DEPTH,
  ...
  extern template morpho::component_tree<unsigned, image2d<unsigned>> compute_ctos<rgb8>(const image2d<rgb8>& input,
                                                                                         image2d<uint16>*     depth,
                                                                                         e_ctos_attribute     attribute,
                                                                                         ctos_extra_params_t  params);

  extern template morpho::component_tree<unsigned, image2d<unsigned>> compute_ctos<rgb16>(const image2d<rgb16>& input,
                                                                                          image2d<uint16>*      depth,
                                                                                          e_ctos_attribute    attribute,
                                                                                          ctos_extra_params_t params);
