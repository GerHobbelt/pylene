...
namespace mln
{
  ...
  image2d<rgb8> reconstruct_from_graph(const Graph& g, const image2d<vec3u>& pmap, const ColorMap& vmap);
  ...
  image2d<rgb8> reconstruct_from_graph(const Graph& g, const graph_t& fg, const tree_t& t1, const tree_t& t2,
                                       const tree_t& t3, const AMap& val1, const AMap& val2, const AMap& val3,
