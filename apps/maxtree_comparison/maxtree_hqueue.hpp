  ...
  namespace morpho
  {
    ...
    namespace internal
    {
      ...
      struct maxtree_flood_algorithm
      {
        ...
        maxtree_flood_algorithm(const I& ima, image2d<size_type>& parent, const Neighborhood&, StrictWeakOrdering,
                                size_type* Send = NULL)
        ...
        static void run(const I& ima, image2d<size_type>& parent, const Neighborhood& nbh, StrictWeakOrdering cmp,
                        size_type* Send)
        {
