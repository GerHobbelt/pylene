...
main(int argc, char** argv)
{
  ...
  desc.add_options()("no-sat", "do not saturate");

  po::options_description hidden;
  desc.add_options()("mask.pbm", po::value<std::string>())("input.ppm", po::value<std::string>())(
      "out.ppm", po::value<std::string>());

  po::positional_options_description pd;
  pd.add("mask.pbm", 1).add("input.ppm", 1).add("out.ppm", 1);
