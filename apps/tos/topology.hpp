...
namespace mln
{
  ...
  ///
  template <typename I>
  void Kdisplay(const Image<I>& ima, const point2d strides = point2d{1, 1});
  ...
  template <typename I>
  void Kdisplay(const Image<I>& ima_, const point2d strides)
  {
  ...
  namespace K1
  {
    inline bool is_face_2(const point2d& p) { return (p[0] % 2 == 0 and p[1] % 2 == 0); }

    inline bool is_face_1(const point2d& p) { return ((p[0] % 2 == 0) xor (p[1] % 2 == 0)); }

    inline bool is_face_1v(const point2d& p) { return (p[0] % 2 == 0 and p[1] % 2 == 1); }

    inline bool is_face_1h(const point2d& p) { return (p[0] % 2 == 1 and p[1] % 2 == 0); }
