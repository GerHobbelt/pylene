...
\node[txt, thick, draw=DarkBlue] (h) [base right=of g] { \verb|[](int x) { return 255-x; }|};
...
\node[img, yslant=.5, DarkRed] (u1) [right=of u] { \includegraphics[width=1.75cm]{images/Olena-c6gradi.png} };
...
\node[img, yslant=.5] (p7) [right=3.1cm of p5.south west, anchor=south west] { \includegraphics[width=2cm]{images/Olena-c6gradi-neg.png} };
