...
#define MLN_GENERATE_CONST_UNARY_EXPR(Name, Obj)                                                                       \
  template <typename I>                                                                                                \
  unary_image_expr<Obj<typename I::value_type>, const I&> Name(const Image<I>& ima)                                    \
  {                                                                                                                    \
...
#define MLN_GENERATE_CONST_BINARY_EXPR(Name, Obj)                                                                      \
  ...
  binary_image_expr<Obj<mln_value(I1), mln_value(I2)>, I1, I2> Name(const Image<I1>& ima1, const Image<I2>& ima2)      \
  {                                                                                                                    \
