...
namespace mln
{
  ...
  namespace internal
  {
    ...
    namespace impl
    {
      ...
      auto
      tuple_transform(std::tuple<TTypes...>& tuple, F f, std::index_sequence<k...>)
      {
      ...
      template <class F, class... TTypes, std::size_t... k>
      auto
      tuple_transform(const std::tuple<TTypes...>& tuple, F f, std::index_sequence<k...>)
      {
      ...
      void
      tuple_for_each(Tuple& tuple, F f, std::index_sequence<k...>)
      {
