...
namespace mln
{
  ...
  template <typename Image, typename SiteIterator>
  struct image_access_value_iterator
      : iterator_base<image_access_value_iterator<Image, SiteIterator>, typename image_value<Image>::type,
  ...
  public:
    ...
    image_access_value_iterator(Image& ima, SiteIterator p) : m_ima(&ima), m_p(p) {}

    template <class Image2, class SiteIterator2>
    image_access_value_iterator(
        const image_access_value_iterator<Image2, SiteIterator2>& other,
  ...
  private:
    ...
    friend struct image_access_value_iterator;
  ...
  struct image_access_pixel
  {
    ...
    image_access_pixel(Image& ima, const SiteIterator& p, MorpherImage& morph) : m_morpher(&morph), m_ima(&ima), m_p(p)
    {
    }
    ...
    friend struct image_access_pixel_iterator;
    template <class, class, class>
    friend struct image_access_pixel;
  ...
  template <typename Image, typename SiteIterator, typename MorpherImage>
  struct image_access_pixel_iterator : iterator_base<image_access_pixel_iterator<Image, SiteIterator, MorpherImage>,
  ...
  public:
    ...
    image_access_pixel_iterator(Image& ima, const SiteIterator& p, MorpherImage& morpher) : m_pix(ima, p, morpher) {}
