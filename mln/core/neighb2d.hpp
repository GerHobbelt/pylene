...
namespace mln {
  ...
  struct c4_t : neighborhood_base< c4_t, mln::array<point2d, 4> >
  {
    ...
    static const mln::array<point2d, 4> dpoints;
  };

  const mln::array<point2d, 4> c4_t::dpoints = {{{ {{-1,0}}, {{0,-1}}, {{0,1}}, {{1,0}} }}};
  ...
  struct c8_t : neighborhood_base< c8_t, mln::array<point2d, 8> >
  {
    ...
    static const mln::array<point2d, 8> dpoints;
  };

  const mln::array<point2d, 8> c8_t::dpoints = {{{ {{-1,-1}}, {{-1,0}}, {{-1,1}},
						   {{0, -1}},           {{0, 1}},
						   {{1,-1}},  {{1,1}},  {{1,0}} }}};
