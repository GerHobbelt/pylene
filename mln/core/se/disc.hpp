...
namespace mln
{
  namespace se
  {
    ...
    struct disc : dyn_neighborhood_base<dynamic_neighborhood_tag, disc>
    {
      /// Create a disc of a given radius with or without approximation
      /// If no approximation is given, the radial decomposition of the disc
