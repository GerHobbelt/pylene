...
namespace mln
{
  ...
  namespace morpho
  {
    ...
    namespace impl
    {
      ...
      void accumulate_proper_index(const Tree& tree, const I& ima, Accu acc, Pmap& vmap, PixFunctor pixfun)
      {
        acc.init();
      ...
      template <class Tree, class I, class Accu, class Pmap, class PixFunctor>
      void accumulate_index(const Tree& tree, const I& ima, Accu acc, Pmap& vmap, PixFunctor pixfun)
      {
        acc.init();
        property_map<Tree, Accu> accmap(tree, acc);
      ...
      void accumulate_ordered_index(const Tree& tree, const I& ima, Accu acc, Pmap& vmap, IFunctor ifun)
      {
        (void)ima;
        acc.init();
        property_map<Tree, Accu> accmap(tree, acc);
