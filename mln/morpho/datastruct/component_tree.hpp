...
namespace mln
{
  ...
  namespace morpho
  {
    ...
    struct component_tree
    {
      ...
      static constexpr vertex_id_t npos()
      {
        return 0; // sentinel index.
      }

      node_type nend() const { return node_type(this, npos()); }
      /// \}
    ...
    struct component_tree<P, AssociativeMap>::pset_iterator : mln::iterator_base<pset_iterator, P, const P&>
    {
      ...
      bool finished() const { return m_cur == m_end; }
        ...
        : mln::iterator_base<pset_reverse_iterator, P, const P&>
    {
      ...
      void init() { m_cur = m_end; }

      void next() { --m_cur; }

      bool finished() const { return m_cur == m_begin; }
        ...
        : mln::iterator_base<children_iterator, node_type, node_type>
    {
      ...
      void next() { m_cur = m_data->m_nodes[m_cur].m_next_sibling; }

      bool finished() const { return m_cur == m_end; }

      node_type dereference() const { return node_type(m_tree, m_cur); }
    ...
    struct component_tree<P, AssociativeMap>::node_type
    {
      ...
      vertex_id_t id() const { return m_node_id; }
      ...
      {
        mln_precondition(m_tree);
        return get_next_node_id() != npos() and m_data->m_nodes[get_next_node_id()].m_parent == m_node_id;
      }
    ...
    template <class P, class AssociativeMap>
    struct component_tree<P, AssociativeMap>::node_iterator : iterator_base<node_iterator, node_type, node_type>
    {
      ...
      void next() { m_current = m_data->m_nodes[m_current].m_next; }

      bool finished() const { return m_current == m_end; }

      node_type dereference() const { return node_type(m_tree, m_current); }
        ...
        : iterator_base<node_reverse_iterator, node_type, node_type>
    {
      ...
      void next() { m_current = m_data->m_nodes[m_current].m_prev; }
    ...
    struct component_tree<P, AssociativeMap>::node_range
    {
      ...
      iterator iter() const { return iterator(m_tree, m_node_id, m_ignore_root); }

      reverse_iterator riter() const { return reverse_iterator(m_tree, m_node_id, m_ignore_root); }
    ...
    template <class P, class AssociativeMap>
    inline typename component_tree<P, AssociativeMap>::size_type component_tree<P, AssociativeMap>::size() const
    {
    ...
    template <class P, class AssociativeMap>
    inline typename component_tree<P, AssociativeMap>::pset_range component_tree<P, AssociativeMap>::pset() const
    {
    ...
    template <class P, class AssociativeMap>
    inline component_tree<P, AssociativeMap> component_tree<P, AssociativeMap>::get_subtree(vertex_id_t v) const
    {
      mln_precondition(v < size());
    ...
    template <class P, class AssociativeMap>
    inline typename component_tree<P, AssociativeMap>::_data_t* component_tree<P, AssociativeMap>::_get_data()
    {
      return m_data.get();
    }
    ...
    template <class P, class AssociativeMap>
    inline typename component_tree<P, AssociativeMap>::node_type component_tree<P, AssociativeMap>::get_root() const
    {
      return get_node(m_root);
    }

    template <class P, class AssociativeMap>
    inline bool component_tree<P, AssociativeMap>::operator==(const component_tree& other) const
    {
    ...
    template <class P, class AssociativeMap>
    void component_tree<P, AssociativeMap>::_reorder_pset()
    {
    ...
    template <class P, class AssociativeMap>
    void component_tree<P, AssociativeMap>::shrink_to_fit()
    {
