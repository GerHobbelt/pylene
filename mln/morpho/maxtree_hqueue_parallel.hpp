...
namespace mln
{
  ...
  namespace morpho
  {
    ...
    namespace impl
    {
	  ...
	  internal::maxtree_flood_algorithm<image2d<V>, Neighborhood, StrictWeakOrdering>::run(ima, parent, m_nbh, m_cmp);
	...
	{
	  MaxTreeAlgorithmHQ<V, Neighborhood, StrictWeakOrdering> algo(ima, nbh, cmp);
