...
namespace mln
{
  ...
  namespace morpho
  {
    ...
    template <typename I, typename Compare>
    pset<I, Compare, false>::pset(const I& ima, const Compare& cmp) : m_set(cmp_t{ima, cmp})
    {
    }

    template <typename I, typename Compare>
    void pset<I, Compare, false>::insert(const value_type& v)
    {
      m_set.insert(v);
    }

    template <typename I, typename Compare>
    bool pset<I, Compare, false>::empty() const
    {
      return m_set.empty();
    }

    template <typename I, typename Compare>
    bool pset<I, Compare, false>::has_previous(const value_type& p) const
    {
    ...
    template <typename I, typename Compare>
    bool pset<I, Compare, false>::has_next(const value_type& p) const
    {
      mln_precondition(!empty());
    ...
    template <typename I, typename Compare>
    typename I::size_type pset<I, Compare, false>::find_previous(const value_type& p) const
    {
    ...
    template <typename I, typename Compare>
    typename I::size_type pset<I, Compare, false>::find_next(const value_type& p) const
    {
    ...
    template <typename I, typename Compare>
    typename I::size_type pset<I, Compare, false>::pop_previous(const value_type& p)
    {
      mln_precondition(has_previous(p));
    ...
    template <typename I, typename Compare>
    typename I::size_type pset<I, Compare, false>::pop_next(const value_type& p)
    {
      mln_precondition(has_next(p));
    ...
    template <typename I, typename Compare>
    inline pset<I, Compare, true>::pset(const I& ima, const Compare& cmp) : m_ima(ima), m_cmp(cmp), m_size(0)
    {
    ...
    template <typename I, typename Compare>
    inline void pset<I, Compare, true>::insert(const value_type& v)
    {
      auto k = h(m_ima[v]);
      m_next[v] = m_hq[k];
      m_hq[k] = v;
    ...
    template <typename I, typename Compare>
    inline bool pset<I, Compare, true>::empty() const
    {
      return m_size == 0;
    }

    template <typename I, typename Compare>
    inline bool pset<I, Compare, true>::has_previous(const value_type& v) const
    {
    ...
    template <typename I, typename Compare>
    inline bool pset<I, Compare, true>::has_next(const value_type& v) const
    {
      auto k = h(m_ima[v]);
    ...
    template <typename I, typename Compare>
    inline typename pset<I, Compare, true>::value_type pset<I, Compare, true>::find_previous(const value_type& v) const
    {
      mln_precondition(!empty());
      auto k = h(m_ima[v]);
      while (m_hq[--k] == npos)
    ...
    template <typename I, typename Compare>
    inline typename pset<I, Compare, true>::value_type pset<I, Compare, true>::find_next(const value_type& v) const
    {
      mln_precondition(!empty());
      auto k = h(m_ima[v]);
      while (m_hq[k] == npos)
    ...
    template <typename I, typename Compare>
    inline typename pset<I, Compare, true>::value_type pset<I, Compare, true>::pop_previous(const value_type& v)
    {
      mln_precondition(!empty());
      auto k = h(m_ima[v]);
      while (m_hq[--k] == npos)
    ...
    template <typename I, typename Compare>
    inline typename pset<I, Compare, true>::value_type pset<I, Compare, true>::pop_next(const value_type& v)
    {
      mln_precondition(!empty());
      auto k = h(m_ima[v]);
      while (m_hq[k] == npos)
