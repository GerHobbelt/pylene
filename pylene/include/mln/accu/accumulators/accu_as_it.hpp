  ...
  namespace accu
  {
    ...
    namespace accumulators
    {
      ...
      struct accu_as_it : Accumulator<accu_as_it<Accu>>
      {
        ...
        void take(const argument_type& x) { m_accu.take(x); }

        void take(const Accu& x) { m_accu.take(x); }

        void take(const accu_as_it& x) { m_accu.take(x.m_accu); }

        void untake(const argument_type& x) { m_accu.untake(x); }

        void untake(const Accu& x) { m_accu.untake(x.m_accu); }

        const Accu& to_result() const { return m_accu; }
