...
namespace mln
{
  ...
  void accumulate_local(I f, const experimental::StructuringElement<SE>& se, const AccumulatorLike<A>& accu, extension::border_manager<bmm> bm, J g);

  template <class A, class I, class SE, extension::border_management bmm>
  ch_value_t<I, accu::result_of_t<A, image_value_t<I>>>
  accumulate_local(I f, const experimental::StructuringElement<SE>& se,  const AccumulatorLike<A>& accu, extension::border_manager<bmm> bm);
  ...
  template <class A, class I, class J, class SE, extension::border_management bmm>
  void accumulate_local(I f, const experimental::StructuringElement<SE>& se_, const AccumulatorLike<A>& accu_, extension::border_manager<bmm> bm, J g)
  {
