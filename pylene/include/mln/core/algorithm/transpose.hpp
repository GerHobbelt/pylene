...
namespace mln
{
  ...
  void transpose(const Image<I>& ima, Image<J>& out);

  template <class I>
  image2d<mln_value(I)> transpose(const Image<I>& ima);
  ...
  template <class I, class J>
  void transpose(const Image<I>& ima_, Image<J>& out_)
  {
  ...
  namespace internal
  {
    ...
    template <class I>
    image2d<mln_value(I)> transpose_init_out(const I& ima, box2d d, extension::extension_tag)
    {
      (void)ima;
    ...
    template <class I>
    image2d<mln_value(I)> transpose_init_out(const I& ima, box2d d, extension::border_extension_tag)
    {
