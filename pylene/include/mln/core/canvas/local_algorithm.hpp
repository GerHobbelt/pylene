...
namespace mln::canvas
{
  ...
  private:
    ...
    virtual void EvalBeforeLocalLoop(image_reference_t<I> pval_i,
                                     image_reference_t<J> pval_j)      = 0;
    virtual void EvalInLocalLoop(image_reference_t<I> nval_i,
                                 image_reference_t<I> pval_i,
                                 image_reference_t<J> pval_j)          = 0;
    virtual void EvalAfterLocalLoop(image_reference_t<I> pval_i,
                                    image_reference_t<J> pval_j)       = 0;
  };
  ...
  private:
    virtual void EvalInDecLoop(image_reference_t<I> nval_i,
                               image_reference_t<I> pval_i,
                               image_reference_t<J> pval_j)          = 0;

    virtual void EvalInIncLoop(image_reference_t<I> nval_i,
                               image_reference_t<I> pval_i,
                               image_reference_t<J> pval_j)          = 0;
  };
