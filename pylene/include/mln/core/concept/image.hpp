...
namespace mln
{
  ...
  struct Image_
  {
    ...
    BOOST_CONCEPT_USAGE(Image_)
    {
      ...
      MLN_CONCEPT_ASSERT_IF(image_traits<I>::concrete::value, ConcreteImage<I>);

      MLN_CONCEPT_ASSERT_IF((std::is_convertible<category, forward_image_tag>::value), IterableImage<I>);

      MLN_CONCEPT_ASSERT_IF(image_traits<I>::indexable::value, IndexableImage<I>);

      MLN_CONCEPT_ASSERT_IF(image_traits<I>::accessible::value, AccessibleImage<I>);

      MLN_CONCEPT_ASSERT_IF(image_has_extension<I>::value, ImageWithExtension<I>);
    }
  ...
  struct ImageWithExtension
  {
    BOOST_CONCEPT_USAGE(ImageWithExtension) { BOOST_CONCEPT_ASSERT((Extension<typename I::extension_type>)); }
  };
  ...
  public:
    ...
    BOOST_CONCEPT_USAGE(ConcreteImage)
    {
      ...
      MLN_CONCEPT_ASSERT_IF(image_traits<I>::indexable::value, check_indexable<I>);
    }
  };
  ...
  public:
    ...
    static_assert(std::is_convertible<category, forward_image_tag>::value, "Image category must be iterable");
