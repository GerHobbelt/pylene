...
namespace mln
{
  ...
  class clip_view : public image_adaptor<I>, public New_Image<clip_view<I, D>>
  {
    D m_domain;
  ...
  public:
    ...
    using domain_type = D;
    using concrete_type  = clip_view<concrete_t<I>, D>;

    template <class V>
    using ch_value_type  = clip_view<ch_value_t<I, V>, D>;
    /// \}
  ...
  public:
    ...
    internal::initializer<concrete_type, clip_view> concretize() const
    {
      return { *this };
    }
