...
namespace mln
{
  ...
  public:
    ...
    static_assert(
      std::conjunction_v< std::is_same<image_point_t<Images>, point_type>... >,
  ...
  private:
    ...
    std::enable_if_t<accessible::value, dummy>
    all_domain_has(point_type p)
    {
  ...
  namespace view
  {
    ...
    {
      static_assert(std::conjunction_v<is_a<Images, New_Image>...>,
