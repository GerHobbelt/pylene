...
namespace mln
{
  ...
  struct image_pixel
  {
    typedef typename std::conditional<std::is_const<Image>::value, typename Image::const_pixel_type,
  ...
  {
    typedef typename std::conditional<std::is_const<Image>::value, typename Image::const_reference,
  ...
  {
    typedef typename std::conditional<std::is_const<Image>::value, typename Image::const_pointer,
  ...
  {
    typedef typename std::conditional<std::is_const<Image>::value, typename Image::const_value_range,
  ...
  {
    typedef typename std::conditional<std::is_const<Image>::value, typename Image::const_pixel_range,
...
#define MLN_GENERATE_META_IMAGE_OPERATORS(meta_op, op)                                                                 \
  ...
  {                                                                                                                    \
    ...
    struct apply                                                                                                       \
    {                                                                                                                  \
      typedef typename op<typename std::remove_reference<Image>::type>::type type;                                     \
    };                                                                                                                 \
  };
