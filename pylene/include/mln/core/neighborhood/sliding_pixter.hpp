...
namespace mln
{
  ...
  template <class Pixel, class SiteSet>
  sliding_pixter<Pixel, SiteSet> make_sliding_pixter(const Pixel& pixel, const SiteSet& pset)
  {
    return {pixel, pset};
  }
} // namespace mln
...
namespace mln
{
  ...
  private:
    ...
    static_assert(image_traits<Image>::accessible::value or image_traits<Image>::indexable::value,
