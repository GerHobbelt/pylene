...
namespace mln
{
  ...
  namespace internal
  {
    ...
    struct meta_get_iterator
    {
      ...
      template <typename R>
      typename range_iterator<R>::type operator()(R& range) const
      {
    ...
    struct meta_get_const_iterator
    {
      ...
      template <typename R>
      typename range_const_iterator<R>::type operator()(const R& range) const
      {
        return rng::iter(range);
      }
    };
  ...
  private:
    ...
    typedef std::tuple<typename range_iterator<typename std::remove_reference<TRanges>::type>::type...> iterator_tuple;
    typedef std::tuple<typename range_const_iterator<typename std::remove_reference<TRanges>::type>::type...>
  ...
  namespace rng
  {
    ...
    template <class... TRanges>
    zip_range<std::tuple<TRanges...>> zip(TRanges&&... ranges)
    {
