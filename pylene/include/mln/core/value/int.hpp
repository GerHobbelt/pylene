...
namespace std
{
  ...
  struct common_type<mln::UInt<n>, V> : common_type<typename boost::uint_t<n>::least, V>
  {
  };

  template <unsigned n, typename V>
  struct common_type<V, mln::UInt<n>> : common_type<V, typename boost::uint_t<n>::least>
  {
  };
  ...
  template <unsigned n, typename V>
  struct common_type<mln::Int<n>, V> : common_type<typename boost::int_t<n>::least, V>
  {
  };
