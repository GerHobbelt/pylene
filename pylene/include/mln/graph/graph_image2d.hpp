  ...
  namespace graph
  {
    ...
    namespace internal
    {
      ...
      struct undirected_graph_ndimage_data
      {
        ...
        template <unsigned d>
        typename std::enable_if<d == dim - 1>::type m_construct_rec(char* ptr, const Vtype& v, const Etype& e);

        template <unsigned d>
        typename std::enable_if<d != dim - 1>::type m_construct_rec(char* ptr, const Vtype& v, const Etype& e);

        template <unsigned d>
        typename std::enable_if<d == dim - 1>::type m_destruct_rec(char* ptr);

        template <unsigned d>
        typename std::enable_if<d != dim - 1>::type m_destruct_rec(char* ptr);

        static constexpr std::size_t m_alignment = std::alignment_of<Vtype>::value > std::alignment_of<Etype>::value
                                                       ? std::alignment_of<Vtype>::value
                                                       : std::alignment_of<Etype>::value;
    ...
    {
    private:
      typedef mln::internal::nested_loop_iterator<internal::graph_edge_visitor_forward<point<short, 2>>,
                                                  mln::internal::no_op_visitor, mln::internal::no_op_visitor,
                                                  mln::internal::point_structure<short, 2>,
                                                  mln::internal::deref_return_point_policy>
          edges_iterator;

      static const int N = Nbh::static_size;

      typedef iterator_range<sliding_piter<std::reference_wrapper<const point2d>, std::array<point2d, N>>> nbh_range;
    ...
    public:
      ...
      undirected_graph_image2d(const box2d& domain, const Nbh& nbh, unsigned border = 3, const Vtype& v = Vtype(),
                               const Etype& e = Etype());
...
namespace mln
{
  namespace graph
  {
    ...
    namespace internal
    {
      ...
      template <typename Vtype, typename Etype, unsigned dim>
      undirected_graph_ndimage_data<Vtype, Etype, dim>::undirected_graph_ndimage_data(size_t* shape_, unsigned border,
                                                                                      Vtype v, Etype e)
      {
      ...
      struct graph_edge_visitor_forward
      {
        ...
        template <size_t n>
        bool finished(const P& point) const
        {
    ...
    template <typename Vtype, typename Etype, typename Nbh>
    inline point2d undirected_graph_image2d<Vtype, Etype, Nbh>::source(const point2d& e) const
    {
    ...
    template <typename Vtype, typename Etype, typename Nbh>
    inline point2d undirected_graph_image2d<Vtype, Etype, Nbh>::target(const point2d& e) const
    {
      mln_precondition(m_domain.has(e));
      mln_precondition(_is_edge(e));
      int x = e[0], y = e[1];
    ...
    template <typename Vtype, typename Etype, typename Nbh>
    inline bool undirected_graph_image2d<Vtype, Etype, Nbh>::_is_vertex(const point2d& v)
    {
      return v[0] % 2 == 0 and v[1] % 2 == 0;
    }

    template <typename Vtype, typename Etype, typename Nbh>
    inline bool undirected_graph_image2d<Vtype, Etype, Nbh>::_is_edge(const point2d& e)
    {
      return !_is_vertex(e);
    }

    template <typename Vtype, typename Etype, typename Nbh>
    inline Vtype& undirected_graph_image2d<Vtype, Etype, Nbh>::vertex_at(const point2d& v)
    {
    ...
    template <typename Vtype, typename Etype, typename Nbh>
    inline const Vtype& undirected_graph_image2d<Vtype, Etype, Nbh>::vertex_at(const point2d& v) const
    {
      mln_precondition(_is_vertex(v));
    ...
    template <typename Vtype, typename Etype, typename Nbh>
    inline Etype& undirected_graph_image2d<Vtype, Etype, Nbh>::edge_at(const point2d& e)
    {
      mln_precondition(_is_edge(e));
      char* ptr = m_ptr_origin;
    ...
    template <typename Vtype, typename Etype, typename Nbh>
    inline const Etype& undirected_graph_image2d<Vtype, Etype, Nbh>::edge_at(const point2d& e) const
    {
      mln_precondition(_is_edge(e));
      const char* ptr = m_ptr_origin;
    ...
    template <typename Vtype, typename Etype, typename Nbh>
    inline Vtype& undirected_graph_image2d<Vtype, Etype, Nbh>::vertex(const point2d& v)
    {
    ...
    template <typename Vtype, typename Etype, typename Nbh>
    inline const Vtype& undirected_graph_image2d<Vtype, Etype, Nbh>::vertex(const point2d& v) const
    {
      mln_precondition(m_domain.has(v));
      return vertex_at(v);
    }
    ...
    template <typename Vtype, typename Etype, typename Nbh>
    inline Etype& undirected_graph_image2d<Vtype, Etype, Nbh>::edge(const point2d& e)
    {
      mln_precondition(m_domain.has(e));
      return edge_at(e);
    }
    ...
    template <typename Vtype, typename Etype, typename Nbh>
    inline const Etype& undirected_graph_image2d<Vtype, Etype, Nbh>::edge(const point2d& e) const
    {
      mln_precondition(m_domain.has(e));
      return edge_at(e);
    }
