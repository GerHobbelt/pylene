...
namespace mln
{
  namespace labeling
  {
    ...
    namespace impl
    {
      ...
      Label rag(const I& ima, const N& nbh, Graph& graph, Label lbl, J&& out)
      {
    ...
    {
      static_assert(std::is_convertible<mln_value(I), bool>::value, "Image value type must be convertible to bool.");
      ...
      static_assert(std::is_same<typename boost::graph_traits<Graph>::edge_parallel_category,
                                 boost::disallow_parallel_edge_tag>::value,
