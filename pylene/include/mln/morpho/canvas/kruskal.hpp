...
namespace mln::morpho::canvas
{
  namespace details
  {
    struct kruskal_default_visitor
    {
      ...
      void on_union(mln::dontcare_t /*p*/, mln::dontcare_t /*rp*/, mln::dontcare_t /*q*/, mln::dontcare_t /*rq*/,
                    mln::dontcare_t /*w*/)
      {
      }
      ...
      /// \param rp Root in the path compressed parent table of \p q
      /// \param w Weight of the edge
      void on_processing(mln::dontcare_t /*p*/, mln::dontcare_t /*rp*/, mln::dontcare_t /*q*/, mln::dontcare_t /*rq*/,
                         mln::dontcare_t /*w*/)
      {
      }
