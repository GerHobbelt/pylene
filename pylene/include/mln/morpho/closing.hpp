...
namespace mln::morpho
{
  ...
  void closing(InputImage&& image, const mln::details::StructuringElement<SE>& se, BorderManager bm,
               OutputImage&& out);
  ...
  template <class InputImage, class SE>
  image_concrete_t<std::remove_reference_t<InputImage>> closing(InputImage&& image, const mln::details::StructuringElement<SE>& se)
  {
  ...
  template <class InputImage, class SE, class BorderManager>
  image_concrete_t<std::remove_reference_t<InputImage>> closing(InputImage&& image, const mln::details::StructuringElement<SE>& se, BorderManager bm,
