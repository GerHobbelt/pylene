...
namespace mln
{
  ...
  namespace morpho
  {
    ...
    void cut_and_reconstruct(const component_tree<P, Amap>& tree, const CriterionMap& criterion_map,
                             const ValueMap& value_map, OutputImage&& out);

    template <class P, class Amap, class CriterionMap>
    void cut_inplace(component_tree<P, Amap>& tree, const CriterionMap& criterion_map);
    ...
    template <class P, class Amap, class CriterionMap, class ValueMap, class OutputImage>
    void cut_and_reconstruct(const component_tree<P, Amap>& tree, const CriterionMap& pred, const ValueMap& value_map,
                             OutputImage&& out)
    {
