...
namespace mln
{
  ...
  namespace morpho
  {
    ...
    void filter_min_inplace(component_tree<P, Amap>& tree, const PredicateMap& predicate_map);
    ...
    template <class P, class Amap, class PredicateMap>
    void filter_max_inplace(component_tree<P, Amap>& tree, const PredicateMap& predicate_map);

    /// \brief Direct filtering strategy
    /// A node is remove if it does not pass the predicate, the others
    /// remain.
    template <class P, class Amap, class PredicateMap>
    void filter_direct_inplace(component_tree<P, Amap>& tree, const PredicateMap& predicate_map);
    ...
    void filter_direct_and_reconstruct(const component_tree<P, Amap>& tree, const PredicateMap& predicate_map,
                                       const ValueMap& value_map, OutputImage&& out);
    ...
    template <class P, class Amap, class PredicateMap>
    void filter_max_inplace(component_tree<P, Amap>& tree, const PredicateMap& pred)
    {
    ...
    template <class P, class Amap, class PredicateMap>
    void filter_direct_inplace(component_tree<P, Amap>& tree, const PredicateMap& pred)
    {
