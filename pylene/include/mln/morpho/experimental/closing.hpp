...
namespace mln::morpho::experimental
{
  ...
  void closing(InputImage&& image, const mln::experimental::StructuringElement<SE>& se, BorderManager bm,
               OutputImage&& out);
  ...
  closing(InputImage&& image, const mln::experimental::StructuringElement<SE>& se, BorderManager bm,
  ...
  closing(InputImage&& image, const mln::experimental::StructuringElement<SE>& se, OutputImage&& out);
  ...
  template <class InputImage, class SE>
  image_concrete_t<std::remove_reference_t<InputImage>> closing(InputImage&& image, const mln::experimental::StructuringElement<SE>& se)
  {
  ...
  template <class InputImage, class SE, class BorderManager>
  image_concrete_t<std::remove_reference_t<InputImage>> closing(InputImage&& image, const mln::experimental::StructuringElement<SE>& se, BorderManager bm,
