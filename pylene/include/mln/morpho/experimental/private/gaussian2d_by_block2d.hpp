...
namespace mln::morpho::experimental::details
{
  ...
  template <class T, class BinaryFunction>
  void running_gaussian2d_algo_t<T, BinaryFunction>::apply_sup(std::byte* __restrict A_, std::byte* __restrict B_,
  ...
  template <class T, class BinaryFunction>
  void running_gaussian2d_algo_t<T, BinaryFunction>::partial_sum_block2d(const std::byte* __restrict in,
