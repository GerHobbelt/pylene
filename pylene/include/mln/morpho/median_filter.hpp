...
namespace mln::morpho
{
  ...
  median_filter(InputImage&& image, const mln::details::StructuringElement<SE>& se, BorderManager bm);

  template <class InputImage, class SE, class BorderManager, class OutputImage>
  void median_filter(InputImage&& image, const mln::details::StructuringElement<SE>& se, BorderManager bm,
                     OutputImage&& out);
  ...
  template <class InputImage, class SE, class BorderManager, class OutputImage>
  void median_filter(InputImage&& input, const mln::details::StructuringElement<SE>& se, BorderManager bm,
                     OutputImage&& out)
  {
