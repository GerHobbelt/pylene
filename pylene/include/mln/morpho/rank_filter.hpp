...
namespace mln::morpho
{
  ...
  rank_filter(InputImage&& image, const mln::details::StructuringElement<SE>& se, BorderManager bm);

  template <class Ratio, class InputImage, class SE, class BorderManager, class OutputImage>
  void rank_filter(InputImage&& image, const mln::details::StructuringElement<SE>& se, BorderManager bm,
                   OutputImage&& out);
  ...
  template <class Ratio, class InputImage, class SE, class BorderManager, class OutputImage>
  void rank_filter(InputImage&& input, const mln::details::StructuringElement<SE>& se, BorderManager bm,
                   OutputImage&& out)
  {
