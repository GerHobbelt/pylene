...
namespace mln
{
  ...
  namespace morpho
  {
    ...
    namespace structural
    {
      ...
      O& closing(const Image<I>& input, const StructuringElement<SE>& se, Compare cmp, Image<O>& out);

      /// \ingroup morpho
      /// \overload OutputImage& closing(const Image<I>&, const StructuringElement<SE>&, Compare cmp,
      /// Image<OutputImage>&)
      template <class I, class SE, class Compare = productorder_less<mln_value(I)>>
      mln_concrete(I) closing(const Image<I>& input, const StructuringElement<SE>& se, Compare cmp = Compare());
      ...
      namespace impl
      {
        ...
        void closing(const I& ima, const SE& nbh, Compare cmp, J& out)
        {
      ...
      mln_concrete(I) closing(const Image<I>& ima_, const StructuringElement<SE>& se, Compare cmp)
      {
        const I& ima = exact(ima_);
