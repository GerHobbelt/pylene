  ...
  namespace morpho
  {
    namespace ToS
    {
      namespace impl
      {
        ...
        template <class I>
        mln_ch_value(I, int) propagation(const Image<I>& f, mln_point(I) start_point, int& max_depth,
        ...
        mln_ch_value(I, int) propagation_impl(const Image<I>& f_, mln_point(I) start_point, int& max_depth,
