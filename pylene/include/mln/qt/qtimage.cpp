...
namespace mln
{
  ...
  namespace qt
  {
    ...
    const image2d<rgb8>& QtImageBase::getView() const { return m_view; }

    image2d<rgb8>& QtImageBase::getView() { return m_view; }

    const QImage& QtImageBase::getQImage() const { return m_qima; }

    QImage& QtImageBase::getQImage() { return m_qima; }
