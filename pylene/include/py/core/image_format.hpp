...
namespace mln
{
  ...
  template <>
  struct sample_type_id_traits<sample_type_id::OTHER> : details::sample_link<sample_type_id::OTHER, void>
  {
  };
  ...
  template <typename T>
  struct sample_type_traits : details::sample_link<sample_type_id::OTHER, T>
  {
  };
