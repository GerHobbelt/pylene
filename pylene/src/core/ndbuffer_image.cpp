...
namespace mln
{
  ...
  sample_type_id __ndbuffer_image<void, -1>::sample_type() const noexcept { return m_sample_type; }

  value_set<> __ndbuffer_image<void, -1>::get_value_set() const noexcept { return {}; }

  int __ndbuffer_image<void, -1>::pdim() const noexcept { return m_pdim; }


  int __ndbuffer_image<void, -1>::width() const noexcept { return m_axes[0].domain_end - m_axes[0].domain_begin; }


  int __ndbuffer_image<void, -1>::height() const noexcept { return m_axes[1].domain_end - m_axes[1].domain_begin; }


  int __ndbuffer_image<void, -1>::depth() const noexcept { return m_axes[2].domain_end - m_axes[2].domain_begin; }
  ...
  const void* __ndbuffer_image<void, -1>::operator[](index_type i) const noexcept { return Impl::get_pointer(this, i); }


  void* __ndbuffer_image<void, -1>::operator[](index_type i) noexcept { return Impl::get_pointer(this, i); }
  ...
  std::ptrdiff_t __ndbuffer_image<void, -1>::byte_stride(int dim) const noexcept { return m_axes[dim].byte_stride; }
  ...
  std::shared_ptr<internal::ndbuffer_image_data>& __ndbuffer_image<void, -1>::__data() { return m_data; }

  const std::shared_ptr<internal::ndbuffer_image_data>& __ndbuffer_image<void, -1>::__data() const { return m_data; }
