...
namespace mln::py
{
  ...
  void* any_span::cursor::read() const { return m_ptr; }
  ...
  any_span::cursor any_span::begin_cursor() { return any_span::cursor(m_buffer, m_type.dyn_sizeof()); }

  any_span::cursor any_span::end_cursor() { return any_span::cursor(m_buffer + m_size * m_type.dyn_sizeof(), 0); }
} // namespace mln::py