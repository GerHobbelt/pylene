...
{
  struct KalmanIRISA final : public Filter_impl
  {
    ...
    KalmanIRISA(int t_integration, Eigen::Matrix<float, 3, 1> observation, const Descriptor& descriptor);
    ~KalmanIRISA() override = default;
