...
namespace scribo
{
  ...
  {
    auto [segs, _] = detect_line(std::move(image), min_len, params);
  ...
  {
    auto [segs, nsegs] = detect_line(std::move(img_in), min_len, params);
  ...
  {
    auto [segs, nsegs] = detect_line(std::move(image), min_len, params);
