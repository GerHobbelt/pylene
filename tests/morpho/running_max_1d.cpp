...
INSTANTIATE_TEST_CASE_P(se_leq_size, RunningMax1d,
                        ::testing::Values(std::make_tuple(1, 3, 0),     // Identity
...
INSTANTIATE_TEST_CASE_P(negative_offset, RunningMax1d,
                        ::testing::Values(std::make_tuple(1, 3, -1),     // Identity
...
INSTANTIATE_TEST_CASE_P(positive_offset, RunningMax1d,
                        ::testing::Values(std::make_tuple(1, 3, 1),      // Identity
...
INSTANTIATE_TEST_CASE_P(negative_offset, RunningMin1d,
                        ::testing::Values(std::make_tuple(1, 3, -1),     // Identity
                                          std::make_tuple(12, 1, -2),    // Identity
                                          std::make_tuple(5, 7, -3),     // n multiple of k
...
INSTANTIATE_TEST_CASE_P(positive_offset, RunningMin1d,
                        ::testing::Values(std::make_tuple(1, 3, 1),      // Identity
                                          std::make_tuple(12, 1, 10),    // Identity
